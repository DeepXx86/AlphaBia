...
namespace NNInputs {
  ...
  //V203 = V202 + active ResultsBeforeNN (mate oracle feeds globals 1-5 / plane 39 and value override)
  const int NUM_FEATURES_SPATIAL_V203 = 48;
  const int NUM_FEATURES_GLOBAL_V203 = 64;
